...
export default function CategoryPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      if (categoryResponse) {
        console.log(categoryResponse[categoryKey]);
  ...
  //     const getBrandsLogo = response.BestSellingBrands;
  //     setBestSellingBrands(getBrandsLogo);
  //     console.log(getBrandsLogo);
  //   };
  ...
  return (
    <div>
      ...
      <CategoryComponent category={categoryState || []} />
      {/*    برند  */}
      <Brand
        targetBrand={
          categoryKey === "men"
